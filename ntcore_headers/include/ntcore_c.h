...
NT_StartConnectionDataLog(NT_Inst inst, struct WPI_DataLog *log,
 ...
 */
struct NT_Meta_TopicPublisher *
NT_Meta_DecodeTopicPublishers(const uint8_t *data, size_t size, size_t *count);
 ...
 */
struct NT_Meta_TopicSubscriber *
NT_Meta_DecodeTopicSubscribers(const uint8_t *data, size_t size, size_t *count);
 ...
 */
struct NT_Meta_ClientPublisher *
NT_Meta_DecodeClientPublishers(const uint8_t *data, size_t size, size_t *count);
 ...
 */
struct NT_Meta_ClientSubscriber *
NT_Meta_DecodeClientSubscribers(const uint8_t *data, size_t size,
                                size_t *count);
